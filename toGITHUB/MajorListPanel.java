...
public class MajorListPanel extends JPanel implements ActionListener{
	...
	public MajorListPanel(Schedule s, ScheduleGUI schGUI){
	...
	public void update(Schedule schedule){
		...
		String creditsCountdownText = MajorListPanel.cHText 
				+ Math.max(0, schedule.getCreditHoursComplete()) 
				+ MajorListPanel.chInformText;
